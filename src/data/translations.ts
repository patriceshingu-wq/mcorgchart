export const translations = {
  en: {
    ...
    personTitle: 'Title (e.g., Pastor, Minister)',
    ...
    confirm: 'Confirm',
    active: 'Active',
    activeDesc: 'Position is filled with someone assigned',
    vacant: 'Vacant',
    vacantDesc: 'Position exists but no one is assigned',
    inactive: 'Inactive',
    inactiveDesc: 'Ministry/department has been suspended or discontinued',
    english: 'English',
    french: 'French',
    both: 'Both',
    seniorLeadership: 'Senior Leadership',
    executiveLeadership: 'Executive Leadership',
    ministrySystem: 'Ministry',
    ...
    updated: 'Updated',
    deleted: 'Deleted',
    noAuditLogs: 'No change history available.',
    loadingLogs: 'Loading change history...',
  ...
  fr: {
    ...
    personTitle: 'Titre (ex: Pasteur, Ministre)',
    ...
    confirm: 'Confirmer',
    active: 'Actif',
    activeDesc: 'Le poste est occupé par une personne assignée',
    vacant: 'Vacant',
    vacantDesc: "Le poste existe mais personne n'est assigné",
    inactive: 'Inactif',
    inactiveDesc: 'Ministère/département suspendu ou abandonné',
    english: 'Anglais',
    french: 'Français',
    both: 'Les deux',
    seniorLeadership: 'Direction principale',
    executiveLeadership: 'Direction exécutive',
    ministrySystem: 'Ministère',
    ...
    undo: 'Annuler',
    redo: 'Rétablir',
    includeSiblings: 'Inclure les frères/sœurs',
    ...
    updated: 'Mis à jour',
    deleted: 'Supprimé',
    noAuditLogs: 'Aucun historique de modifications disponible.',
    loadingLogs: 'Chargement de l\'historique...',
    viewHistory: 'Voir l\'historique',
    filterByNode: 'Filtrer par nœud',
    filterByUser: 'Filtrer par utilisateur',
    filterByOperation: 'Filtrer par opération',
